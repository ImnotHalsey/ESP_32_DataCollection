...
from features import features, W25QxxFlashMemory
...
class Camera():
    ...
    def _read_fifo_data(self):
        file_path = f"{self.timestamp.get_timestamp()}.jpg"
        with open(file_path, "wb") as file:
            while self.received_length > 0:
                file.write(self._read_byte())
        return file_path
...
class CameraController:
    ...
    def init_camera(self):
        spi_camera = SPI(2, sck=Pin(14), miso=Pin(02), mosi=Pin(15))
